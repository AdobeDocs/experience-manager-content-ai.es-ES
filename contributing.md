...
Aunque cualquier contribución es bienvenida para mejorar la documentación de AEM, asegúrese de que las contribuciones se ajusten a determinadas directrices y normas, siempre que sea posible. Revise las [Directrices para contribuir a la documentación de AEM](guidelines.md) para obtener más información.
...
Si usted es un empleado de Adobe y tiene una contribución que hacer, utilice la organización `Adobe-Enterprise-Docs` en el Git corporativo.
